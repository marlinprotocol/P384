...
describe("Wallet", function(accounts) {
  async function deployFixture() {
    const wallet = await ethers.deployContract(
      "Wallet",
      [
  ...
  it("should verify", async function() {
    ...
    let tx = await wallet.test_verify({ gas: 20000000000000 });
    console.log(tx);
  });
  ...
  it("should verify signatures", async function() {
    let wallet = await loadFixture(deployFixture);
    let result = await wallet.verifySignature(
      "0x413140d54372f9baf481d4c54e2d5c7bcf28fd6087000280e07976121dd54af2",
      "0x00000000000000000000000000000000eeb9131427fd0f0b7195733c60dd8a99",
      "0x822e6250b731e570244afe1053226cc83bcfb2a4280b6f2a81f2a723f62a457e",
      "0x00000000000000000000000000000000ee281a7e5d0ea6a14e00c1759f79fddb",
